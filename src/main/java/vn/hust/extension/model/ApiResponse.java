package vn.hust.extension.model;

import com.google.gson.JsonElement;
import com.google.gson.JsonNull;
import lombok.AllArgsConstructor;
import lombok.Getter;
import vn.hust.extension.constant.ConstantPrimitive;
	...
	private <T> T parserJsonConstructor(Class<T> clazz) {
		try {
			if (Number.class.isAssignableFrom(clazz))
				return clazz.getDeclaredConstructor(ConstantPrimitive.getPrimitiveClass(clazz)).newInstance(0);
